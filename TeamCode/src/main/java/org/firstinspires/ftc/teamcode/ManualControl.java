...
public class ManualControl extends OpMode {
    ...
    void controlRuleta(){
        if (gamepad1.x && !ruletaButtonPressed && !ruletaActivatedBACK) {
        ...
        if (gamepad1.a && !ruletaButtonPressedBACK && !ruletaActivated) {
            ruletaButtonPressedBACK = true;
            ruletaActivatedBACK = !ruletaActivatedBACK;

            if(ruletaActivatedBACK)
                robot.ruleta.setPower(-1);
            else
                robot.ruleta.setPower(0);
        } else if (!gamepad1.a && ruletaButtonPressedBACK)
            ruletaButtonPressedBACK = false;
    }
