 ...
 */
@Autonomous(name = "Odometrie cu reset ADAPTAT TEAM ELEMENT")
public class OdometrieCuResetAdaptatTeamElement extends LinearOpMode {
    private static final String TFOD_MODEL_ASSET = "modelTrained.tflite";
